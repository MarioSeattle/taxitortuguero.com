...
<svg class="hide" xmlns="http://www.w3.org/2000/svg" version="1.1">
    <defs>
        ...
        <symbol>
            <g id="mail">
                <path d="M102.608,290.182L289,418.736V122.789L102.608,290.182z M-223,122.789v295.947l186.388-128.572L-223,122.789z M33,352.691
            l-44.501-39.955L-223,441h512L77.495,312.736L33,352.691z M273.64,121h-481.28L33,301.926L273.64,121z"/>
            </g>
        </symbol>

        <symbol id="lifebuoy" viewBox="0 0 1024 1024">
        ...
        <symbol id="bubble" viewBox="0 0 1024 1024">
...
<div class="footer-wrap">
    <div class="footer-top group mainfoot">
        <div class="row">
            <div class="twelve columns">
                <p><a href="https://www.facebook.com/Guzmans-Water-Taxi-1060209700715132/?notify_field=phone">Facebook</a> | <a href="tel:+506 83443885">Give us a call +506 83443885</a></p>
            </div>
        </div>
    </div>
    <div class="footer-top group mobfoot">
        <div class="row">
            <div id="callmob">
                <a href="tel:+506 83443885">
          <span>
                  <svg class="icon" viewBox="0 0 578.106 578.106">
                      <use xlink:href="#icon-phone" />
                  </svg>
               </span>
                    <span class="icontext">Llamanos</span>
                </a>
            </div>
            <div id="mailmob">
                <a href="sms:+506 83443885">
          <span>
                   <svg class="icon" viewBox="-223 25 512 512">
                       <use xlink:href="#mail" />
                   </svg>
                 </span>
                    <span class="icontext">Mensaje</span>
                </a>
            </div>

            <div id="testmob">
                <a href="https://www.facebook.com/Guzmans-Water-Taxi-1060209700715132/?notify_field=phone">
          <span>
            ...
            <div id="supportmob">
                <a href="https://es.wikipedia.org/wiki/Parque_nacional_Tortuguero">
          <span>
                   <svg class="icon" viewBox="0 0 1024 1024">
                       <use xlink:href="#lifebuoy" />
                   </svg>
                 </span>
                    <span class="icontext">Website</span>
                </a>a
            </div>
    ...
    <div class="footer-bottom group">
        <div class="row moblowerfoot">
            <div class="twelve columns">
                <p>&copy;The contents appearing on this website are the property of Tortuguero Taxi Copyright© since 2015. Design By Mario Gomez</p>
            </div>
        </div>
    </div>
</div>
